...
class Directory {
    constructor(filePath, url) {
        ...
        const canvasesPattern = filePath + '/_*';
    ...
    _createIndexJson() {
        if (this.isCollection) {
            ...
            this.directories.forEach((directory) => {
                ...
                Utils_1.Utils.getThumbnail(itemJson, directory.url, directory.filePath);
            ...
            this.items.forEach((canvas, index) => {
        ...
        this._applyMetadata();
        Utils_1.Utils.getThumbnail(this.indexJson, this.url, this.filePath);
        // write index.json
